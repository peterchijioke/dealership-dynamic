...
export default function VehicleCard({vehicle}: {vehicle: Vehicle}) {
  ...
  return (
    <div
      className="sticky top-32 space-y-4 max-h-[calc(100vh-62px)] overflow-y-auto bg-white rounded-3xl min-h-[420px] p-6 w-full shadow-xs max-w-sm"
    >
      <div>
        ...
        <div className=" hidden md:block py-2">
          ...
          <button
            className="active:opacity-90 select-none min-w-[48px] min-h-[44px] md:min-h-[41px] inline-flex items-center justify-center border-solid border-2 font-semibold focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-primary-500 md:transition-all md:duration-200 px-7 active:scale-[.99] hover:scale-[1.05] text-base rounded-full pl-0 pr-1 mr-4 border-transparent hover:text-primary-600 text-primary-500 mb-2 w-full flex-row"
            aria-haspopup="false"
          >
