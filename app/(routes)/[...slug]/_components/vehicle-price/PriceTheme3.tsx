...
function PriceTheme3(props: Props) {
	...
	const priceItemClassName = 'price-theme3-item flex justify-between items-baseline py-2';
	const dotClassName = 'price-theme3-dot grow border-b border-neutral-600 border-dotted';
	...
	return (
		<div className="price-theme3-root text-neutral-600">
			...
			{dealer_discount_label &&
				dealer_discount_details.map((el) => (
					<div className={priceItemClassName + ' price-theme3-discount-row'} key={el.title}>
			...
			{dealer_additional_label &&
				dealer_additional_details.map((el) => (
					<div className={priceItemClassName + ' price-theme3-additional-row'} key={el.title}>
			...
			{incentive_discount_label &&
				incentive_discount_details.map((el) => (
					<div className={priceItemClassName + ' price-theme3-incentive-row'} key={el.title}>
			...
			{sale_price_label && retail_price_label && (
				<div className={priceItemClassName + ' price-theme3-final-highlight-row'}>
					<div className="price-theme3-final-highlight-label uppercase text-dark text-h5">{sale_price_label}</div>
					<div className={dotClassName} />
