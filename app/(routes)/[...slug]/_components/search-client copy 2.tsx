...
export default function SearchClient({
    ...
    const updateFacet = async (facet: string, value: string) => {
        ...
        const res = await searchWithMultipleQueries({
            hitsPerPage: HITS_PER_PAGE, // no hits, only facets
