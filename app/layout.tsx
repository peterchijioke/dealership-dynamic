...
export const metadata: Metadata = {
  metadataBase: new URL(process.env.NEXT_PUBLIC_SITE_URL || 'https://yourdealership.com'),
  title: {
  ...
  description: 'Find your perfect vehicle at Your Dealership Name. Browse our extensive inventory of quality pre-owned and new cars, trucks, and SUVs with competitive pricing and excellent service.',
  keywords: ['used cars', 'new cars', 'car dealership', 'auto sales', 'vehicles for sale', 'trucks', 'SUVs', 'sedans'],
  ...
  openGraph: {
    ...
    description: 'Find your perfect vehicle at Your Dealership Name. Browse our extensive inventory with competitive pricing and excellent service.',
    images: [
      {
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "url": process.env.NEXT_PUBLIC_SITE_URL || "https://yourdealership.com",
              "logo": `${process.env.NEXT_PUBLIC_SITE_URL || "https://yourdealership.com"}/logo.png`,
              "image": `${process.env.NEXT_PUBLIC_SITE_URL || "https://yourdealership.com"}/dealership-image.jpg`,
              "description": "Quality pre-owned and new vehicles with competitive pricing and excellent service.",
              "address": {
                "@type": "PostalAddress",
